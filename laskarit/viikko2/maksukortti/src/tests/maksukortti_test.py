...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syö_maukkaasti_ei_vie_saldoa_negatiivikseksi(self):
    ...
    def test_negatiivisen_summan_lataaminen_ei_muuta_kortin_saldoa(self):
        self.kortti.lataa_rahaa(-240)
        self.assertEqual(self.kortti.saldo_euroina(), 10.0)
    
    def test_kortilla_voi_ostaa_vain_edullisen_lounaan(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_kortilla_voi_ostaa_vain_maukkaan_lounaan(self):
